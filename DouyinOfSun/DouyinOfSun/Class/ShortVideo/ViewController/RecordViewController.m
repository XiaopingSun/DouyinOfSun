...
- (void)setupBaseToolboxView {
    ...
    backButton.frame = CGRectMake(15, 30, 36, 36);
    ...
    filterButton.frame = CGRectMake(10, 75, 35, 35);
    [filterButton setTitle:@"滤镜" forState:UIControlStateNormal];
    [filterButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    filterButton.titleLabel.font = [UIFont systemFontOfSize:16];
    ...
    self.viewRecordButton.frame = CGRectMake(10, 120, 35, 35);
    ...
    self.viewRecordButton.titleLabel.font = [UIFont systemFontOfSize:16];
    ...
    beautyFaceButton.frame = CGRectMake(10, 165, 35, 35);
    ...
    beautyFaceButton.titleLabel.font = [UIFont systemFontOfSize:16];
    ...
    flashButton.frame = CGRectMake(10, 210, 35, 35);
    ...
    toggleCameraButton.frame = CGRectMake(10, 255, 35, 35);
...
- (void)setupRightButtonView {
    ...
    int index = 0;
    // 拍照
    self.snapshotButton = [[UIButton alloc] initWithFrame:CGRectMake(0, index * 60 + 75, 46, 46)];
    ...
    index ++;
    // 是否使用背景音乐
    self.musicButton = [[UIButton alloc] initWithFrame:CGRectMake(0, index * 60 + 75, 46, 46)];
    ...
    index ++;
    // 30FPS/60FPS
    self.frameRateButton = [[UIButton alloc] initWithFrame:CGRectMake(0, index * 60 + 75, 46, 46)];
    ...
    self.rightScrollView.contentSize = CGSizeMake(60, index * 75 + 10);
}
...
- (void)musicButtonOnClick:(id)sender {
    ...
    if (self.musicButton.selected) {
        // 背景音乐
        NSURL *audioURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"Yusee_ - 心如止水（cover：ICE PAPER）" ofType:@"mp3"]];
