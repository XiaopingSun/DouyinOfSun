...
extension RecommendViewController {
    private func initSubviews() {
        ...
        view.addSubview(positionSegment!)
        ...
        view.addSubview(videoToolBoxLabel)
        ...
        view.addSubview(videoToolBoxSegment!)
        ...
        view.addSubview(sessionPresetLabel)
        ...
        view.addSubview(sessionPresetButton!)
        ...
        view.addSubview(videoSizeLabel)
        ...
        view.addSubview(videoSizeButton!)
    ...
    @objc private func startPush() {
        ...
        let pushUrl = (urlTextField?.text?.replacingOccurrences(of: " ", with: ""))!
